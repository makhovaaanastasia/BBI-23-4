...
//         // объединение результатов лыжников и лыжниц в один массив
//         Athlete[] combinedResults = new Athlete[skierMenGroup1.Length + skierMenGroup2.Length + skierWomenGroup1.Length + skierWomenGroup2.Length];
//         CopyMas(skierMenGroup1, combinedResults, 0);
//         CopyMas(skierMenGroup2, combinedResults, skierMenGroup1.Length);
//         CopyMas(skierWomenGroup1, combinedResults, skierMenGroup1.Length + skierMenGroup2.Length);
//         CopyMas(skierWomenGroup2, combinedResults, skierMenGroup1.Length + skierMenGroup2.Length + skierWomenGroup1.Length);
